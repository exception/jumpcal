        ...
        <Body className="mx-auto my-auto bg-white font-sans">
          <Container className="mx-auto my-10 rounded-md border border-solid border-neutral-200 p-10">
            ...
            <Text className="text-sm text-black mb-4">
              Hey {callerFirst ?? callerName}! Thanks for using Jumpcal for your
              recent call with {targetName}.
            </Text>
            ...
            <Text className="text-xs text-neutral-950">
              Did you know that by using Jumpcal you are saving a ton of
              scheduling time? Don&apos;t have an account?{" "}
              <Link
